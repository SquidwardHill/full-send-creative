...
const navbar = () => {
  ...
  const navItems = [
    ...
    { id: 5, text: <Icon icon="fa6-brands:dribbble" className="w-24 h-24" />, href: "https://www.linkedin.com/in/sydneyhill/" },
    { id: 6, text: <Icon icon="fa6-brands:github" className="w-24 h-24" />, href: "https://github.com/sydneyhill" },
  ];
